    ...
    return (
        ...
        >
            ...
            <span className="flex flex-row items-center gap-1 hover:underline underline-offset-4">
                ...
                <a
                    className="hover:text-[var(--text)] text-[var(--link)]"
                    href="https://github.com/adoante/cpp-telemetry-log-parser"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    UAV Telemetry Data Parser and Anomaly Detection
                </a>
            </span>
            ...
            <span className="flex flex-row items-center gap-1 hover:underline underline-offset-4">
                ...
                <a
                    className="hover:text-[var(--text)] text-[var(--link)]"
                    href="https://duckduckgo.com/?q=c%2Fc%2B%2B+and+tools"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    C/C++ and Tools
