		...
		<main className="space-y-10">
			...
			<section className="flex flex-col space-y-10">
				...
				<p className="text-[var(--text-muted)]">
					In case it{`'`}s something important you can contact me using email: <Link className="hover:text-[var(--text)] text-[var(--link)]" href="mailto:adolfogante@gmail.com">adolfogante@gmail.com</Link>
				</p>
			...
			<section className="flex flex-col space-y-10">
				...
				<p>
					...
					other than <Link className="cursor-pointer text-[var(--link)] hover:text-[var(--text)]" href="https://linkedin.com/in/adolfogante">LinkedIn</Link>.
				</p>
			</section>
			...
			<section className="flex flex-col space-y-10">
				...
				<p className="text-[var(--text-muted)]">
					...
					Fill out the form below to send me a message that will be physically printed from a <a
						className="text-[var(--link)] hover:text-[var(--text)]"
				...
				<div className="bg-[var(--highlight)] p-2 rounded-sm">
					<TicketContact />
				</div>
			</section>
		</main>
